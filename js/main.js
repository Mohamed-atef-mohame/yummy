...
function contactUs() {
    ...
    />
    <div class="alert alert-danger alert-name d-none" role="alert">
  ...
  <div class="col-lg-6">
    ...
    />
    <div class="alert alert-danger alert-email d-none" role="alert">
  ...
  <div class="col-lg-6">
    ...
    />
    <div class="alert alert-danger alert-phone d-none" role="alert">
  ...
  <div class="col-lg-6">
    ...
    />
    <div class="alert alert-danger alert-age d-none" role="alert">
      Enter valid age
    </div>
  </div>
  <div class="col-lg-6">
    ...
    />
    <div class="alert alert-danger alert-password d-none" role="alert">
  ...
  <div class="col-lg-6">
    <input
      ...
      type="password"
      class="form-control search-letter user-repassword"
    />
    <div class="alert alert-danger alert-repassword d-none" role="alert">
      Enter valid repassword
    </div>
  </div>

  <button class="btn btn-outline-danger sub disabled">Submit</button>`
